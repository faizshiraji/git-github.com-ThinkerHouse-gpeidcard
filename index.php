<?php 
error_reporting(0);
require_once( 'gp-campaign/include_file/db.php' ); 
?>
<!DOCTYPE html>
<html lang="en">
<head>
    ...
    (function(d, s, id) {
        ...
        fjs.parentNode.insertBefore(js, fjs);
                            ...
                            if ($file !== false) {
                                ...
                                $sql = "INSERT INTO `registration_info`(`name`, `image_name`, `page_url`, `date_time`) VALUES ('$name','$imageName.$imageFileType','$filename','$dateTime')";
