...
// THIS CONDITION FOR IF USER NOT LOGGED IN
...
$selectUser = mysqli_query($connect,"SELECT COUNT(*) AS total FROM registration_info");
$fetchUser = mysqli_fetch_array($selectUser);
$totalUser = $fetchUser['total'];
...
<head>
  ...
  <title>Report Panel | Dashboard</title>
...
<div class="wrapper">
  ...
  <header class="main-header">
    ...
    <a href="../index.php" class="logo">
      ...
      <span class="logo-lg"><b>REPORT</b>PANEL</span>
    </a>
