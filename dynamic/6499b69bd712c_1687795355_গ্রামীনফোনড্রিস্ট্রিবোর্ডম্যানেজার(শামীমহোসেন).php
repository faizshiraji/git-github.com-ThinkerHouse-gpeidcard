            ...
            <div class="col-md-12" id="photo">
                ...
                <div class="dynamic-info-inner">
                    <div class="dynamic-client-info">
                        ...
                        <img src="../images/userImages/6499b69bd712c_1687795355_গ্রামীনফোনড্রিস্ট্রিবোর্ডম্যানেজার(শামীমহোসেন).jpg" alt="" class="img img-responsive">
                    </div>
                 </div>

                <div class="col-md-12">
                    <center><button type="button" class="btn title_button" style="border: none; cursor: pointer; background-color: none;"><span><b>গ্রামীনফোন ড্রিস্ট্রিবোর্ড ম্যানেজার (শামীম হোসেন)</b></span></button></center>
                </div>
