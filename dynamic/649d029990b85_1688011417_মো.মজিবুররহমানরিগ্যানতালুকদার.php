            ...
            <div class="col-md-12" id="photo">
                ...
                <div class="dynamic-info-inner">
                    <div class="dynamic-client-info">
                        ...
                        <img src="../images/userImages/649d029990b85_1688011417_মো.মজিবুররহমানরিগ্যানতালুকদার.jpg" alt="" class="img img-responsive">
                    </div>
                 </div>

                <div class="col-md-12">
                    <center><button type="button" class="btn title_button" style="border: none; cursor: pointer; background-color: none;"><span><b>মো.মজিবুর রহমান রিগ্যান তালুকদার </b></span></button></center>
                </div>
