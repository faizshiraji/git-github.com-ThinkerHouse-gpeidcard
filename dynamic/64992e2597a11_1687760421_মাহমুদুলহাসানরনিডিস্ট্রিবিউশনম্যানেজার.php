            ...
            <div class="col-md-12" id="photo">
                ...
                <div class="dynamic-info-inner">
                    <div class="dynamic-client-info">
                        ...
                        <img src="../images/userImages/64992e2597a11_1687760421_মাহমুদুলহাসানরনিডিস্ট্রিবিউশনম্যানেজার.jpeg" alt="" class="img img-responsive">
                    </div>
                 </div>

                <div class="col-md-12">
                    <center><button type="button" class="btn title_button" style="border: none; cursor: pointer; background-color: none;"><span><b>মাহমুদুল হাসান রনি  ডিস্ট্রিবিউশন ম্যানেজার </b></span></button></center>
                </div>
