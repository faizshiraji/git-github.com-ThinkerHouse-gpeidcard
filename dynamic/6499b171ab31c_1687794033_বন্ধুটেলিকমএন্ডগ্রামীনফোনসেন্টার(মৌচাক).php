            ...
            <div class="col-md-12" id="photo">
                ...
                <div class="dynamic-info-inner">
                    <div class="dynamic-client-info">
                        ...
                        <img src="../images/userImages/6499b171ab31c_1687794033_বন্ধুটেলিকমএন্ডগ্রামীনফোনসেন্টার(মৌচাক).jpg" alt="" class="img img-responsive">
                    </div>
                 </div>

                <div class="col-md-12">
                    <center><button type="button" class="btn title_button" style="border: none; cursor: pointer; background-color: none;"><span><b>বন্ধু টেলিকম এন্ড গ্রামীনফোন সেন্টার (মৌচাক) </b></span></button></center>
                </div>
