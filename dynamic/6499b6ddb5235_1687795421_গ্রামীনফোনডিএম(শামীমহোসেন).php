            ...
            <div class="col-md-12" id="photo">
                ...
                <div class="dynamic-info-inner">
                    <div class="dynamic-client-info">
                        ...
                        <img src="../images/userImages/6499b6ddb5235_1687795421_গ্রামীনফোনডিএম(শামীমহোসেন).jpg" alt="" class="img img-responsive">
                    </div>
                 </div>

                <div class="col-md-12">
                    <center><button type="button" class="btn title_button" style="border: none; cursor: pointer; background-color: none;"><span><b>গ্রামীনফোন ডিএম (শামীম হোসেন)</b></span></button></center>
                </div>
