            ...
            <div class="col-md-12" id="photo">
                ...
                <div class="dynamic-info-inner">
                    <div class="dynamic-client-info">
                        ...
                        <img src="../images/userImages/64994c0ba0c03_1687768075_muhammadalidany(distributionmanager,reccorporationunit2).jpg" alt="" class="img img-responsive">
                    </div>
                 </div>

                <div class="col-md-12">
                    <center><button type="button" class="btn title_button" style="border: none; cursor: pointer; background-color: none;"><span><b>Muhammad Ali Dany (Distribution Manager,REC Corporation Unit 2)</b></span></button></center>
                </div>
