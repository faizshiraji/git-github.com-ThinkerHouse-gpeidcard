            ...
            <div class="col-md-12" id="photo">
                ...
                <div class="dynamic-info-inner">
                    <div class="dynamic-client-info">
                        ...
                        <img src="../images/userImages/64995c56593b8_1687772246_ferdausmahbub.manager:sylhettradingagency..jpg" alt="" class="img img-responsive">
                    </div>
                 </div>

                <div class="col-md-12">
                    <center><button type="button" class="btn title_button" style="border: none; cursor: pointer; background-color: none;"><span><b>Ferdaus Mahbub. Manager: Sylhet Trading Agency.</b></span></button></center>
                </div>
