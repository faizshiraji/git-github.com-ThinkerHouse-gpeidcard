            ...
            <div class="col-md-12" id="photo">
                ...
                <div class="dynamic-info-inner">
                    <div class="dynamic-client-info">
                        ...
                        <img src="../images/userImages/64999e515556f_1687789137_চানদিতেলাগাইয়াবুদ্ধিরতেলওরনিরে.jpg" alt="" class="img img-responsive">
                    </div>
                 </div>

                <div class="col-md-12">
                    <center><button type="button" class="btn title_button" style="border: none; cursor: pointer; background-color: none;"><span><b>চানদিতে লাগাইয়া বুদ্ধির তেল ও রনিরে </b></span></button></center>
                </div>
