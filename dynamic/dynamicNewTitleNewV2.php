...
<!--                         <div class="dynamic-name-address">
                    ...
                    <div class="col-md-12">
                        <center><button type="button" class="btn title_button" style="border: none; cursor: pointer; background-color: none;"><span><b>Shahadat Hossain Sadik</b></span></button></center>
                    </div>
                </div>
