            ...
            <div class="col-md-12" id="photo">
                ...
                <div class="dynamic-info-inner">
                    <div class="dynamic-client-info">
                        ...
                        <img src="../images/userImages/64998f28bd40c_1687785256_𝑺𝒉𝒂𝒋𝒂𝒉𝒂𝒏𝒖𝒓𝑹𝒂𝒉𝒂𝒎𝒂𝒏.jpg" alt="" class="img img-responsive">
                    </div>
                 </div>

                <div class="col-md-12">
                    <center><button type="button" class="btn title_button" style="border: none; cursor: pointer; background-color: none;"><span><b>𝑺𝒉𝒂𝒋𝒂𝒉𝒂𝒏𝒖𝒓 𝑹𝒂𝒉𝒂𝒎𝒂𝒏</b></span></button></center>
                </div>
