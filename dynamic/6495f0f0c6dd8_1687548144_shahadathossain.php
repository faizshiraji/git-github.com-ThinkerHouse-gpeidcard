...
<head>
  ...
  <!-- Meta tage here -->
    <meta property="og:url" content="https://test.thinkerhouse.co/share.html" id="meta-url"/>
  <meta property="og:type" content="website" />
  <meta property="og:title" content="Shahadat Hossain" />
...
<div class="container">
    <div class="row">
        ...
        <div class="col-md-6 col-md-offset-3" id="photo">
                ...
                <div class="dynamic-main-page">
                    ...
                    <div class="dynamic-info-inner">
                        <div class="dynamic-client-info">
                            ...
                            <img src="../images/userImages/6495f0f0c6dd8_1687548144_shahadathossain.jpg" alt="">
                        </div>
...
<script type="text/javascript">
   ...
   jQuery(document).ready(function(){
        ...
        let meta-url = document.querySelector("#meta-url");
        meta-url.setAttribute("content", url);
