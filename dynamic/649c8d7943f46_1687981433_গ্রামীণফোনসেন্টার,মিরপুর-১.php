            ...
            <div class="col-md-12" id="photo">
                ...
                <div class="dynamic-info-inner">
                    <div class="dynamic-client-info">
                        ...
                        <img src="../images/userImages/649c8d7943f46_1687981433_গ্রামীণফোনসেন্টার,মিরপুর-১.jpg" alt="" class="img img-responsive">
                    </div>
                 </div>

                <div class="col-md-12">
                    <center><button type="button" class="btn title_button" style="border: none; cursor: pointer; background-color: none;"><span><b>গ্রামীণফোন সেন্টার, মিরপুর-১</b></span></button></center>
                </div>
