            ...
            <div class="col-md-12" id="photo">
                ...
                <div class="dynamic-info-inner">
                    <div class="dynamic-client-info">
                        ...
                        <img src="../images/userImages/6499b7fbe1c59_1687795707_শামিমহোসেন(ডিস্ট্রিবিউটরম্যানেজার)লালমোহনটেরিটরি(সুমনএন্ডব্রাদার্স)(১).jpg" alt="" class="img img-responsive">
                    </div>
                 </div>

                <div class="col-md-12">
                    <center><button type="button" class="btn title_button" style="border: none; cursor: pointer; background-color: none;"><span><b>শামিম হোসেন (ডিস্ট্রিবিউটর ম্যানেজার)  লালমোহন টেরিটরি (সুমন এন্ড ব্রাদার্স) (১)</b></span></button></center>
                </div>
