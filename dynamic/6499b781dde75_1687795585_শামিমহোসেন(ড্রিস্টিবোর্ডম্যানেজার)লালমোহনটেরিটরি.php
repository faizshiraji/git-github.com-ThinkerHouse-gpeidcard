            ...
            <div class="col-md-12" id="photo">
                ...
                <div class="dynamic-info-inner">
                    <div class="dynamic-client-info">
                        ...
                        <img src="../images/userImages/6499b781dde75_1687795585_শামিমহোসেন(ড্রিস্টিবোর্ডম্যানেজার)লালমোহনটেরিটরি.jpg" alt="" class="img img-responsive">
                    </div>
                 </div>

                <div class="col-md-12">
                    <center><button type="button" class="btn title_button" style="border: none; cursor: pointer; background-color: none;"><span><b>শামিম হোসেন (ড্রিস্টিবোর্ড ম্যানেজার)   লালমোহন টেরিটরি</b></span></button></center>
                </div>
