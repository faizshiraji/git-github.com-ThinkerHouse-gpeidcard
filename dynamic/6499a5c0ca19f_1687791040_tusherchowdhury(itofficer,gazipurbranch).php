            ...
            <div class="col-md-12" id="photo">
                ...
                <div class="dynamic-info-inner">
                    <div class="dynamic-client-info">
                        ...
                        <img src="../images/userImages/6499a5c0ca19f_1687791040_tusherchowdhury(itofficer,gazipurbranch).jpg" alt="" class="img img-responsive">
                    </div>
                 </div>

                <div class="col-md-12">
                    <center><button type="button" class="btn title_button" style="border: none; cursor: pointer; background-color: none;"><span><b>Tusher chowdhury (IT officer, Gazipur Branch)</b></span></button></center>
                </div>
