            ...
            <div class="col-md-12" id="photo">
                ...
                <div class="dynamic-info-inner">
                    <div class="dynamic-client-info">
                        ...
                        <img src="../images/userImages/64994d3c057cc_1687768380_tufayelahmed(distributionmanager,reccorporationunit4).jpg" alt="" class="img img-responsive">
                    </div>
                 </div>

                <div class="col-md-12">
                    <center><button type="button" class="btn title_button" style="border: none; cursor: pointer; background-color: none;"><span><b>Tufayel Ahmed (Distribution Manager,REC Corporation Unit 4)</b></span></button></center>
                </div>
