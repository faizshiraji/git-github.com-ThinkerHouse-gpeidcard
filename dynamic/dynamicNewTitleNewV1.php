...
<head>
  ...
  <meta property="og:description" content="Eid Mubarak From GrammeenPhone" />
        ...
        <div class="col-md-6 col-md-offset-3" style="padding-bottom: 10px;">
            ...
            <div class="col-md-4">
                ...
                <a href="https://www.facebook.com/sharer/sharer.php?s=100&p[url]=https://eidcard.thinkerhouse.co/dynamic/dynamicNew.php" target="_blank" onclick="window.open(this.href,'targetWindow','toolbar=no,location=0,status=no,menubar=no,scrollbars=yes,resizable=yes,width=600,height=250'); return false">
                    <button style="width:100%; margin-top:10px;" type="button" class="btn btn-info custom_button" data-href="#link" id="share_button"><i class="fa fa-facebook fa-2"></i> Share On Facebook</button>
                </a>
            </div>
        </div>
                ...
                <div class="dynamic-info-inner">
                    <div class="dynamic-client-info">
                        <div class="dynamic-image">
                            <img src="../images/userImages/2019.jpg" alt="" class="img img-responsive">
                        </div>
<!--                         <div class="dynamic-name-address">
                    ...
                    <div class="col-md-12">
                        <center><button type="button" class="btn btn-info title_button" style="border: none; cursor: pointer; background-color: none;"><span>Shahadat Hossain Sadik</span></button></center>
                    </div>
                </div>
