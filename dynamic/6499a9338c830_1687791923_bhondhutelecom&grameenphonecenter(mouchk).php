            ...
            <div class="col-md-12" id="photo">
                ...
                <div class="dynamic-info-inner">
                    <div class="dynamic-client-info">
                        ...
                        <img src="../images/userImages/6499a9338c830_1687791923_bhondhutelecom&grameenphonecenter(mouchk).jpg" alt="" class="img img-responsive">
                    </div>
                 </div>

                <div class="col-md-12">
                    <center><button type="button" class="btn title_button" style="border: none; cursor: pointer; background-color: none;"><span><b>Bhondhu Telecom & Grameenphone Center (Mouchk)</b></span></button></center>
                </div>
