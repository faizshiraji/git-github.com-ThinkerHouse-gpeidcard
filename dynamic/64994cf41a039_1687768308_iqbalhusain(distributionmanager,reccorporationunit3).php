            ...
            <div class="col-md-12" id="photo">
                ...
                <div class="dynamic-info-inner">
                    <div class="dynamic-client-info">
                        ...
                        <img src="../images/userImages/64994cf41a039_1687768308_iqbalhusain(distributionmanager,reccorporationunit3).jpg" alt="" class="img img-responsive">
                    </div>
                 </div>

                <div class="col-md-12">
                    <center><button type="button" class="btn title_button" style="border: none; cursor: pointer; background-color: none;"><span><b>Iqbal Husain (Distribution Manager,REC Corporation Unit 3)</b></span></button></center>
                </div>
